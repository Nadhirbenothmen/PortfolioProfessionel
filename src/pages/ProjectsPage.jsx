...
const ProjectsPage = () => {
  ...
  const categories = ['All', 'Web & BI', "Full-Stack", 'Frontend', 'Backend', 'BI']
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 pt-24 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h1 className="text-6xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-primary via-blue-600 to-accent mb-4 mt-2">
            All Projects
          </h1>
        ...
        >
          <div className="flex items-center gap-3 p-2 bg-white dark:bg-gray-800 rounded-xl shadow-lg border dark:border-gray-700">
            <FaFilter className="text-primary ml-2" size={18} />
